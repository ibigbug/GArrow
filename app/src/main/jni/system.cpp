...
jstring Java_com_watfaq_garrow_system_getabi(JNIEnv *env, jobject thiz) {
...
jint Java_com_watfaq_garrow_system_exec(JNIEnv *env, jobject thiz, jstring cmd) {
...
void Java_com_watfaq_garrow_system_jniclose(JNIEnv *env, jobject thiz, jint fd) {
close(fd);
}

jint Java_com_watfaq_garrow_system_sendfd(JNIEnv *env, jobject thiz, jint tun_fd, jstring path) {
int fd;
...
static const char *classPathName = "com/watfaq/garrow/System";

static JNINativeMethod method_table[] = {
{
"jniclose", "(I)V",
(void*) Java_com_watfaq_garrow_system_jniclose
},
{
"sendfd", "(ILjava/lang/String;)I",
(void*) Java_com_watfaq_garrow_system_sendfd
},
{
"exec", "(Ljava/lang/String;)I",
(void*) Java_com_watfaq_garrow_system_exec
},
{
"getABI", "()Ljava/lang/String;",
(void*) Java_com_watfaq_garrow_system_getabi
}
};
